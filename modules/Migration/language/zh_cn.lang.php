...
'LBL_MIGRATE'=>'升级到最新版本',
//Added after 5 Beta 
'LBL_UPGRADE_VTIGER'=>'升级 WebCider CRM 数据库',
'LBL_UPGRADE_FROM_VTIGER_423'=>'将数据库从 WebCider CRM 4.2.3 升级到 5.2.1',
'LBL_SETTINGS'=>'设置',
'LBL_STEP'=>'步骤',
'LBL_SELECT_SOURCE'=>'选择来源',
'LBL_STEP1_DESC'=>'升级数据库之前，您必须指定旧数据的保存格式',
'LBL_RADIO_BUTTON1_TEXT'=>'我有访问 WebCider CRM 数据库系统的权限',
'LBL_RADIO_BUTTON1_DESC'=>'这个选项需要您具有数据库服务器的地址和数据库访问权限。本地和远程机器均支持这种访问方法。需要帮助请参考相关文档。',
'LBL_RADIO_BUTTON2_TEXT'=>'我具有访问WebCider CRM数据库存档的权限',
'LBL_RADIO_BUTTON2_DESC'=>'这个选项需要数据库备份文件必须存在本机。您不能从其它机器访问这个备份文件。 需要帮助请参考相关文档。',
'LBL_RADIO_BUTTON3_TEXT'=>'我有4.2.3数据库文件',
'LBL_RADIO_BUTTON3_DESC'=>'这个选项需要WebCider CRM 4.2.3数据库系统的详细信息，包括mysql服务器ID，用户名，密码。您不能远程访问数据。',
...
'LBL_UPGRADE_FROM_VTIGER_5X'=>'升级 WebCider CRM 5.x 数据库到下一个版本',
